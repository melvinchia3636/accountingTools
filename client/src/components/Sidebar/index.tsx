  ...
  return (
    <aside className="w-1/4 h-full border-r border-zinc-700 p-8 flex flex-col">
      <header className="flex items-center gap-2 mb-8">
        <Link
          to="/"
          className="w-8 h-8 transition-all rounded-md hover:bg-zinc-100/10 flex items-center justify-center"
        >
          ...
          <ul className="w-full mt-4 border-l-2 border-zinc-700">
            {everything.data
              ...
              .map((item) => (
                <li
                  key={item.id}
                  className={`w-full py-4 rounded-md cursor-pointer hover:bg-zinc-100/10 ${
